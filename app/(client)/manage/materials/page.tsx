...
export default function ManageMaterialPage() {
  ...
  const handleRemoveUnit = (index: number) => {
    const updatedUnits = formData.materialUnitDtoList.filter(
      (_, i) => i !== index
    );
    setFormData((prev) => ({
      ...prev,
  ...
  const { data: materials, isLoading: isLoadingMaterails } =
    useGetMaterialWarehouse(searchParams);
  const totalPages = materials?.totalPages || 1;
                          ...
                          <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="col-span-2">
                                <label className="font-bold block text-gray-900">
                                  Tên hàng
                                </label>
                                <input
                                  name="name"
                              ...
                              <div>
                                <label
                                  htmlFor="nhomhang"
                                  className="font-bold block text-gray-900 mb-1"
                                >
                                  Chọn danh mục chính:
                                </label>
                                <select
                              ...
                              <Accordion type="single" collapsible>
                                <AccordionItem value="item-1">
                                  ...
                                  <AccordionContent>
                                    <div className="grid grid-cols-4 max-w-[300px]">
                                      <div className="col-span-3">
                                        ...
                                        <div className="flex">
                                          ...
                                          <Dialog>
                                            <DialogTrigger>
                                              <Button className="bg-green-500 hover:bg-green-700 ml-4 text-white px-4 py-2 rounded col-span-1">
                                                +
                                              </Button>
                                            </DialogTrigger>
                                            <DialogContent className="max-w-[500px] max-h-[100vh] overflow-hidden overflow-y-auto">
                                              <DialogHeader>
                                                <DialogDescription>
                                                  <form
                                                    onSubmit={
                                                      handleSubmitUnitForm
                                                    }
                                                  >
                                                    {" "}
                                                    {/* Thêm onSubmit nếu cần */}
                                                    <div>
                                                      <label className="font-bold block text-gray-900">
                                                        Đơn vị mới
                                                      </label>
                                    ...
                                    {formData.materialUnitDtoList.map(
                                      (unit, index) => (
                                        <div
                                          key={unit.unitId}
                  ...
                  <div className="mt-5">
                    <Select onValueChange={handleSelectChange}>
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Chọn trạng thái hàng" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="1">Còn hàng</SelectItem>
                        <SelectItem value="2">Hết hàng</SelectItem>
                        <SelectItem value="3">Trên MinStock</SelectItem>
                        <SelectItem value="4">Dưới MinStock</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                  ...
                  <Accordion type="single" collapsible>
                    <AccordionItem value="item-1">
                      ...
                      >
                        ...
                        <div>
                          {item.variantCostPrice?.toLocaleString("vi-VN") ||
                      ...
                      <AccordionContent>
                        <div className="">
                          <Button
                            className="px-3 py-1 hover:bg-green-300 text-black bg-blue-200 text-sm"
                            onClick={() => setIsActive("chitiet")}
                          >
                            Thông tin sản phẩm{" "}
                          </Button>
                          <Button
                            className="px-3 py-1 hover:bg-green-300 text-black bg-blue-200 ml-3 text-sm"
                            onClick={() => setIsActive("tracking")}
                          >
