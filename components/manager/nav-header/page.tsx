                        ...
                        <div className="flex">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`text-white hover:bg-blue-700  px-8 py-3 text-sm font-medium flex  justify-between items-center ${dropdownOpen.material ? 'bg-blue-700' : ''}`}
                                >
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`text-white hover:bg-blue-700  px-8 py-3 text-sm font-medium flex  justify-between items-center ${dropdownOpen.transaction ? 'bg-blue-700' : ''}`}
                                >
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`text-white hover:bg-blue-700  px-8 py-3 text-sm font-medium flex  justify-between items-center ${dropdownOpen.customer ? 'bg-blue-700' : ''}`}
                                >
                                    <FaBoxArchive className="mr-2 size-4" />
                                    Khách hàng
                                </button>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`text-white hover:bg-blue-700  px-8 py-3 text-sm font-medium flex  justify-between items-center ${dropdownOpen.supplier ? 'bg-blue-700' : ''}`}
                                >
                                    <FaBoxArchive className="mr-2 size-4" />
                                    Nhà cung cấp
                                </button>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`text-white hover:bg-blue-700  px-8 py-3 text-sm font-medium flex  justify-between items-center ${dropdownOpen.services ? 'bg-blue-700' : ''}`}
                                >
                                    <FaBoxArchive className="mr-2 size-4" />
                                    Nhân viên
                                </button>
