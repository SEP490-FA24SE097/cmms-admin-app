...
import AddSupllier from "./add-supplier";
  ...
  return (
    <div className="w-[80%] mx-auto mt-5">
      <div className="grid grid-cols-5 grid-rows-1 gap-4">
        <div className="text-2xl font-bold">Nhà cung cấp</div>
      ...
      <div className="grid grid-cols-5 grid-rows-1 gap-4 mt-5">
        ...
        <div className="col-span-4 ">
          <div className="border h-auto">
            <div className="grid grid-cols-10 grid-rows-1 gap-4 bg-blue-100 p-3 font-bold">
              <div className="col-span-2">Nhà cung cấp</div>
              <div className="col-span-4 col-start-3">Địa chỉ</div>
              <div className="col-span-2 col-start-7">Số điện thoại</div>
              <div className="col-span-2 col-start-9">Email</div>
            </div>
            {suppliers?.data.map((item, index) => (
              ...
              >
                ...
                <div className="col-span-4 col-start-3">{item.address}</div>
                <div className="col-span-2 col-start-7">{item.phoneNumber}</div>
                <div className="col-span-2 col-start-9">{item.email}</div>
              </div>
            ))}
          </div>
        </div>
