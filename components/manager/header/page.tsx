...
export default function ManagerHeader() {
    ...
    return (
        <div className="flex justify-between w-[80%] mx-auto">
            <div className="px-3 py-3 size-5 text-blue-700">
                CMMS
            </div>
            <div>
                <div className="bg-blue-600 items-center flex">
                    <div onMouseEnter={() => handleMouseEnter('settings')}
                        onMouseLeave={() => handleMouseLeave('settings')}
                         className={`relative flex px-3 py-4  ${dropdownOpen.settings ? 'bg-blue-700' : ''}`}>
